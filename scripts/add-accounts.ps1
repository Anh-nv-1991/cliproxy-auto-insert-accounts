...
# Yeu cau PowerShell 7: c├║ ph├íp $var text trong subexpression khong parse duoi 5.1
...
$env:PYTHONIOENCODING = "utf-8"   # gpt-tool in "ΓåÆ" - tranh crash cp1252 khi stdout redirect
...
if (-not $Execute) {
    Write-Output ""
    Write-Output "=== DRYRUN ΓÇö ke hoach ==="
